...
SystemChatBot = [{"role": "system", "content": f"Hello, I am {os.environ['Username']}, You're a content writter. You have to write content like letters, codes, application, essays, notes, songs, poems ect."}]
...
if __name__ == "__main__":
    asyncio.run(Automation(["open chrome ","content song for me","whatsapp"]))
